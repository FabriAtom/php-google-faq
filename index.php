...
<body>
    <header class="nav_container">
        <nav class="nav_bar">
            <div class="logo">
                <img class="img" src="./img/google-1018443_960_720.webp" alt="#">
                <h2 class="titolo">Privacy e termini</h2>
            </div>
            <div class="menu">
                <ul class="flex">
                    <li class="lista">Introduzione</li>
                    <li class="lista">Norme sulla privacy</li>
                    <li class="lista">Termini di servizio</li>
                    <li class="lista">Tecnologie</li>
                    <li class="lista">Domande frequenti</li>
                </ul>
         </div>
     </nav>
 </header>
        ...
        <div class="text">
            ...
            $faq = [
                ...
                [
                    ...
                    'paragrafo' => '<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>',
                    ...
                    'paragrafo' => '<p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel Centro Google per la sicurezza online.</p>',
                    'paragrafo' => '<p>Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>',
                ],
                [
                    'title' => 'Perché il mio account è associato a un paese?',
                    'paragrafo' => '<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>',
                    'paragrafo' => '<p>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</p>',
                    'paragrafo' => '<p>A Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. B Google LLC, con sede negli Stati Uniti, per il resto del mondo.</p>',
                    'paragrafo' => '<p>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</p>',
                    'paragrafo' => '<p>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.</p>',
                ],
                [
                    'title' => 'Stabilire il paese associato al tuo account',
                    'paragrafo' => '<p>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell ultimo anno.</p>',
                    'paragrafo' => '<p>I viaggi frequenti solitamente non influiscono sul paese associato al tuo account. Se ti trasferisci in un altro paese, potrebbe occorrere circa un anno per aggiornare l associazione del paese.</p>',
